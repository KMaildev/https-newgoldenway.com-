        ...
        <div class="container pt-90 pb-40">
            <div class="row">
                <div class="col-md-6 col-lg-6 col-xl-4">
                    <div class="widget tm-widget-contact-info contact-info-style1 contact-icon-theme-colored1">
                        <div class="thumb">
                            <img alt="Logo" src="{{ asset('assets/images/logo-wide-white.png') }}">
                        </div>
                        ...
                        <ul class="mb-30">
                            ...
                            <li class="contact-email">
                                ...
                                <div class="text"><a
                                        href="mailto:contact@yourdomain.com">contact@yourdomain.com</a></div>
                            </li>
                            <li class="contact-website">
                                <div class="icon"><i class="flaticon-contact-035-website"></i></div>
                                <div class="text"><a target="_blank"
                                        href="http://yourdomain.com/">www.yourdomain.com</a></div>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-6 col-md-3 col-lg-3">
                    <div class="widget">
                        <h5 class="widget-title line-bottom mb-10">Call Us Now</h5>
                        <div class="text-gray">
                            +61 3 1234 5678 <br>
                            +12 3 1234 5678
                        </div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-4">
                    <div class="widget">
                        ...
                        <ul class="styled-icons icon-dark icon-theme-colored1 icon-rounded clearfix">
                            <li><a class="social-link" href="#"><i class="fab fa-facebook-f"></i></a>
                            </li>
                            <li><a class="social-link" href="#"><i class="fab fa-twitter"></i></a>
                            </li>
                            <li><a class="social-link" href="#"><i class="fab fa-skype"></i></a>
                            </li>
                            <li><a class="social-link" href="#"><i
                                        class="fab fa-youtube-square"></i></a></li>
                            <li><a class="social-link" href="#"><i class="fab fa-instagram"></i></a>
                            </li>
                            <li><a class="social-link" href="#"><i class="fab fa-pinterest"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="widget">
                        ...
                        <form id="mailchimp-subscription-form1" class="newsletter-form">
                            ...
                            <div class="input-group">
                                <input type="email" id="mce-EMAIL" data-tm-height="45px"
                ...
                <div class="row pt-20 pb-20">
                    <div class="col-sm-6">
                        <div class="footer-paragraph">
                            Copyright ©2022 ThemeMascot. All Rights Reserved
                        </div>
                    </div>
                    <div class="col-sm-6">
